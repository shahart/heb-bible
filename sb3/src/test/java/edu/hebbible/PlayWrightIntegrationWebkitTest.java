...
class PlayWrightIntegrationWebkitTest { // todo with Profile so it will work on my local, but not on github server
    ...
    static void launchBrowser() throws Exception { // setUp
        ...
        browser = playwright.webkit().launch((new BrowserType.LaunchOptions().setHeadless(false))); // 2019 build ("use on your own risk")
